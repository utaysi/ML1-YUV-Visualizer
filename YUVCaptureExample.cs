...
namespace MagicLeap
{
    ...
    /// input.
    /// </summary>
    public class YUVCaptureExample : MonoBehaviour
    {
        ...
        private YUVVisualizer _YUVVisualizer = null;
        ...
        void Awake()
        {
            ...
            OnRawVideoCaptureStarted += _YUVVisualizer.OnCaptureStarted;
            OnRawVideoCaptureEnded += _YUVVisualizer.OnCaptureEnded;
            ...
            OnRawVideoDataReceived += _YUVVisualizer.OnCaptureDataReceived;
            #endif
        }
        ...
        private void OnCameraConnected(MLResult result)
        {
            if (result.IsOk)
            {
                MLCamera.OnRawVideoFrameAvailableYUV += OnCaptureDataReceived;
        ...
        /// </summary>
        private void OnCaptureDataReceived(MLCamera.ResultExtras extras, MLCamera.YUVFrameInfo imagePlane, MLCamera.FrameMetadata frameMetadata)
        {
            OnRawVideoDataReceived?.Invoke(extras, imagePlane, frameMetadata);
        }
        #endif
